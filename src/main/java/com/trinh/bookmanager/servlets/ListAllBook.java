...
public class ListAllBook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		DBManager dbm = (DBManager) getServletContext().getAttribute("BookDBManager");
		...
		try {
			...
			sb.append("<table border=1>" + "<tr><td>Id</td>" + "<td>Ten SP</td>" + "<td>Tac Gia</td>" + "<td>Mo Ta</td>"
					+ "<td>Gia Tien</td>" + "<td>Loai SP</td>" + "<td>Anh Minh Hoa</td></tr>");
			...
			while (rs.next()) {
				...
				sb.append("<tr><td>" + id + "</td>" + "<td>" + tenSP + "</td>" + "<td>" + tacGia + "</td>" + "<td>"
						+ moTa + "</td>" + "<td>" + giaTien + "</td>" + "<td>" + maLoaiSP + "</td>" + "<td>"
						+ anhMinhHoa + "</td></tr>");
			}
			sb.append("</table>");
		} catch (Exception ex) {
